<div class="p-3 border border-gray-200 rounded-lg shadow-lg h-[400px] w-[350px]">
    ...
    <div class="flex flex-col gap-3">
        <ul class=" mt-5 p-4 space-y-2 text-sm">
            ...
            <li>
                <a href="/datos/{{$procedimiento->id}}" class="flex items-center p-2 rounded-lg text-black   group @if(request()->routeIs('gestion.index')) bg-gray-700 @endif">
