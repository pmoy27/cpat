<div class="flex flex-col gap-4">
    ...
    <div class="p-2 border border-gray-200 rounded-lg shadow-lg ">
        <h5 class="text-sm font-semibold ">Menú</h5>
        <div class="flex flex-col gap-3">
            <ul class=" mt-5 p-4 space-y-2 text-sm">
                <li>
                    <a href="/identificacion/{{$procedimiento->id}}" class="flex gap-2 justify-between items-center p-2 rounded-lg text-black   group  @if(request()->routeIs('formulario.identificaciones')) bg-gray-300 @endif">
                        ...
                        <div>
                            @if (is_null($identificacion_vacio))
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler text-orange-600 icons-tabler-outline icon-tabler-alert-triangle">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <path d="M12 9v4" />
                                <path d="M10.363 3.591l-8.106 13.534a1.914 1.914 0 0 0 1.636 2.871h16.214a1.914 1.914 0 0 0 1.636 -2.87l-8.106 -13.536a1.914 1.914 0 0 0 -3.274 0z" />
                                <path d="M12 16h.01" />
                            </svg>
                            @elseif ($identificacion_vacio)
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler text-orange-600 icons-tabler-outline icon-tabler-alert-triangle">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <path d="M12 9v4" />
                                <path d="M10.363 3.591l-8.106 13.534a1.914 1.914 0 0 0 1.636 2.871h16.214a1.914 1.914 0 0 0 1.636 -2.87l-8.106 -13.536a1.914 1.914 0 0 0 -3.274 0z" />
                            ...
                            @else
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon text-green-500 icon-tabler icons-tabler-outline icon-tabler-rosette-discount-check">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <li>
                    <a href="/marco-normativo/{{$procedimiento->id}}" class="flex gap-2 justify-between items-center p-2 rounded-lg text-black   group @if(request()->routeIs('formulario.marco')) bg-gray-300 @endif">
                        <div class="flex items-center">
                ...
                <li>
                    <a href="/usuario/{{$procedimiento->id}}" class="flex gap-2 justify-between items-center p-2 rounded-lg text-black   group @if(request()->routeIs('formulario.usuario')) bg-gray-300 @endif">
                        <div class="flex items-center">
                ...
                @endif
                <li>
                    <a href="/soporte/{{$procedimiento->id}}" class="flex gap-2 justify-between items-center p-2 rounded-lg text-black   group @if(request()->routeIs('formulario.soporte')) bg-gray-300 @endif">
                        <div class="flex items-center">
                ...
                <li>
                    <a href="/digital/{{$procedimiento->id}}" class="flex gap-2 justify-between items-center p-2 rounded-lg text-black   group @if(request()->routeIs('formulario.digital')) bg-gray-300 @endif">
                        <div class="flex items-center ">
                ...
                <li>
                    <a href="/notificaciones/{{$procedimiento->id}}" class="flex gap-2 justify-between items-center p-2 rounded-lg text-black   group @if(request()->routeIs('formulario.notifiaciones')) bg-gray-300 @endif">
                        <div class="flex items-center">
                ...
                <li>
                    <a href="/datos/{{$procedimiento->id}}" class="flex gap-2 justify-between items-center p-2 rounded-lg text-black   group @if(request()->routeIs('formulario.datos')) bg-gray-300 @endif">
                        <div class="flex items-center">
