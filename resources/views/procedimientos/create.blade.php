<div id="modal-crear" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t ">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-toggle="modal-crear">
            ...
            <!-- Modal body -->
            <div class="p-4">
                <form action="{{route('crear.procedimiento')}}" method="post" class="  max-w-2xl m-auto ">
                    @csrf
                    <div class="grid gap-4 mb-4 grid-cols-1">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <select id="Tipo_procedimiento" name="Tipo_procedimiento" class="bg-white border uppercase w-full border-gray-300 text-gray-900 text-xs rounded-sm focus:ring-primary-400 focus:border-primary-600 block " required="">
                                ...
                                <option name="Tipo_procedimiento" value="Procedimiento administrativo de función común">Procedimiento administrativo de función común</option>
                                <option name="Tipo_procedimiento" value="Procedimiento administrativo de función específica">Procedimiento administrativo de función específica</option>
                                <option name="Tipo_procedimiento" value="Otras tramitaciones">Otras tramitaciones</option>
                            </select>
                        </div>
                        <div class="col-span-2 sm:col-span-1">
