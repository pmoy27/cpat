...
<div class="p-4 lg:ml-64  h-full ">
    <div class=" mt-5 max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-end gap-5">
            <a href="/reporte/{{$procedimiento->id}}" target="_blank" class="flex gap-2 p-2 border"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-printer">
